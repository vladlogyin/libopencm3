...
This library supports the A/D Converter Control System in the GD32E23 series
of ARM Cortex Microcontrollers by GigaDevice.

This family only has one ADC.  However all the A/D converters share a common clock which is
...
TODO add info about oversampling
...
TODO fix all mentions of ADC 1 2 & 3
For ADC1 and ADC2
...
The resolution can be one of the following: 12bit, 10bit, 8bit, or 6bit

@param[in] adc Unsigned int32. ADC block register address base @ref
adc_reg_base.
@param[in] res Unsigned int32. ADC resolution from @ref adc_resolution.
*/
void adc_set_resolution(uint32_t adc, uint32_t res)
{
	ADC_CR1(adc) &= ~ADC_CR1_DRES_MASK;
	ADC_CR1(adc) |= res;
}

/*---------------------------------------------------------------------------*/
/** @brief ADC Enable oversampling

ADC needs to be off.

The resolution can be one of the following: 12 TODO bit, 10bit, 8bit, or 6bit

@param[in] adc Unsigned int32. ADC block register address base @ref
adc_reg_base.
@param[in] ratio Unsigned int32. ADC oversampling ratio @ref adc_os_ratio.
@param[in] shift Unsigned int32. ADC oversampling shift @ref adc_os_shift.
@param[in] trigger Unsigned int32. ADC oversampling shift @ref adc_os_shift.
*/
...
/*---------------------------------------------------------------------------*/
/** @brief ADC Disable oversampling
